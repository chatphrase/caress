...
module.exports = function(cfg){
  ...
  // Since this is being used as part of this app, if this app is used first,
  // before the offerPost or offerGet functions, the request will be fine.
  // Kind of an odd situation I'm not sure how to work around.
  app.use(parseTextBody);

  // Function for outer app to use to handle offer POST requests
  app.offerPost = function offerPost(path, req, res, next) {
  ...
  app.offerGet = function offerGet(path,req,res,next){
