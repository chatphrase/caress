...
module.exports = function(cfg) {
  ...
  // Export wrapped offerPost
  var offerPost = require('./routes/offerPost.js')(db, itemTTL);
  ...
  // offerGet doesn't need req.body, so it can be exposed
  // without middleware wrapping
  app.offerGet = require('./routes/offerPost.js')(db);

  // UUID PUT handler, for offer/answer updates
  // (deprecated in favor of update message POSTs)
  app.put(uuidRoute, require('./routes/uuidGet.js')(db));
  ...
  app.get(uuidRoute, require('./routes/uuidGet.js')(db,
